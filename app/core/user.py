...
# асинхронный генератор для доступа к БД через SQLAlchemy
...
# объект класса FastAPIUsers для подключения роутеров
fastapi_users = FastAPIUsers[User, int](
    get_user_manager,
    [auth_backend],
)

# Методы для Dependency Injection и разграничения доступа
